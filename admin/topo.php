...
<body>
    <div id="box_topo">
        ...
        <div id="logo">
            <img src="../img/STCN.png" width="400" />
        </div><!-- logo -->
        ...
        <div id="menu_topo">
            <ul>
                ...
                <li><a href="">CURSOS E DISCIPLINAS</a>
                    <ul>
                        <!--Quando clicar em cadastrar cursos ele vai redirecionar para uma variável global chamada pg=curso/ SE PG FOR IGUAL A CURSO ELE VAI MOSTRAR ABAIXO DO TOPO DA PÁGINA OS CURSOS E DISCIPLINAS.                 -->
